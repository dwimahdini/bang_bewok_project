...
<div class="flex flex-wrap gap-4">
    ...
    <div class="max-w-xs border border-gray-200 rounded-lg shadow" style="background-color: white; width: 200px;">
        ...
        <div class="p-2">
            ...
            <a href="#" class="inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="openDetailModal('{{ $cabang->nama }}', '{{ asset($cabang->image_path) }}', '{{ $cabang->jalan }}', '{{ $cabang->provinsi }}', '{{ $cabang->kota }}', '{{ $cabang->nomor_telepon }}')">
                Detail

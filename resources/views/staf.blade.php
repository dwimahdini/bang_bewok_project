...
<div class="p-1 md:p-1">
    ...
    <div id="frameStaf" class="bg-white p-4 rounded-lg shadow-sm">
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-2 mb-4">
            ...
            <button onclick="openAddStaffModal()" class="border border-gray-300 px-3 py-1.5 text-sm rounded-lg focus:outline-none transition duration-300">
                Tambah Staf
            </button>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 bg-white shadow-md rounded-lg border border-gray-300">
                <thead class="bg-[#906808]">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-center text-xs font-medium text-white uppercase tracking-wider border-r border-gray-300">Nomor Telepon</th>
...
<div id="addStaffModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
    <div class="bg-white rounded-lg p-6 w-full max-w-lg">
        <h2 class="text-xl font-semibold mb-4">Tambah Staf Baru</h2>
        <form action="{{ route('staff.store') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label for="nama" class="block text-sm font-medium mb-2">Nama</label>
                <input type="text" id="nama" name="nama" autocomplete="off" class="w-full border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none transition duration-300" required>
            </div>
            <div class="mb-4">
                <label for="notel" class="block text-sm font-medium mb-2">Nomor Telepon</label>
                <input type="text" id="notel" name="notel" autocomplete="off" class="w-full border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none transition duration-300" required>
            </div>
            <div class="mb-4">
                <label for="email" class="block text-sm font-medium mb-2">Email</label>
                <input type="email" id="email" name="email" autocomplete="off" class="w-full border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none transition duration-300" required>
            </div>
            <div class="mb-4">
                <label for="posisi" class="block text-sm font-medium mb-2">Posisi</label>
                <select id="posisi" name="posisi" class="w-full border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none transition duration-300" required>
            ...
            <div class="mb-4">
                ...
                <select id="cabang" name="cabang" class="w-full border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none transition duration-300" required>
